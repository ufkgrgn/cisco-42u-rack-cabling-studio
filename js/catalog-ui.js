(function () {
  ...
  function init() {
    ...
    function selectCustom(key) {
      ...
      if (status) status.textContent = api.STATE.selectedLibraryItem ? `Seçili: ${api.catalog[key].name}. Kabinde boş bir U seviyesine tıklayın.` : 'Kütüphaneden bir donanım seçin.';
    }
