...
| M3 | Dynamic Variable Rack & Conflict-Free Placement Engine | EIA-310-D rack model (1-60U), front & rear viewpoints, AABB unit interval collision detection, strict height shrinkage prohibition guard, hardware identity & cable endpoint preservation | M1, M2 | PLANNED |
